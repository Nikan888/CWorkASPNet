...
namespace Test_Project_Hotel.ViewModels
{
    public enum SortState
    {
        ...
        WorkerFioAsc, // по ФИО сотрудника по возрастанию
        WorkerFioDesc    // по ФИО сотрудника по убыванию
    }
    ...
    public class SortViewModel
    {
        ...
        public SortState WorkerFioSort { get; set; }    // значение для сортировки по ФИО сотрудника
        ...
        public SortViewModel(SortState sortOrder)
        {
            ...
            WorkerFioSort = sortOrder == SortState.WorkerFioAsc ? SortState.WorkerFioDesc : SortState.WorkerFioAsc;
